...
const LoginForm = () => {
  return (
    <div className="min-h-screen bg-[#F8F9FC] flex flex-col justify-center items-center p-6">
      ...
      <div className="mb-6">
        <img 
          src="/logo-weup.png" // Asegúrate de poner tu logo en public/
          alt="WeUp Logo" 
      ...
      <div className="bg-white p-10 rounded-[40px] shadow-sm border border-gray-100 w-full max-w-[480px]">
        <form className="space-y-6">
          ...
          <div className="flex items-center justify-between text-sm">
            ...
            <a href="#" className="text-[#2D26B5] font-semibold hover:underline">
      ...
      <p className="mt-10 text-gray-600">
        ¿No tienes una cuenta? <span className="text-[#2D26B5] font-bold cursor-pointer hover:underline">Regístrate</span>
      </p>
    </div>
  );
};
